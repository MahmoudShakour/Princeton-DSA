...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private void init() {
        ...
        if (frame == null) {
            ...
            frame.setDefaultCloseOperation(
                    JFrame.DISPOSE_ON_CLOSE);      // closes only current window
    ...
    /**
     * Sets the upper-left hand corner of the drawing window to be (x, y), where (0, 0) is upper
     * left.
     *
    ...
    public void setPenRadius(double radius) {
        ...
        BasicStroke stroke = new BasicStroke((float) penRadius, BasicStroke.CAP_ROUND,
    ...
    public void arc(double x, double y, double radius, double angle1, double angle2) {
        ...
        if (ws <= 1 && hs <= 1) pixel(x, y);
                ...
                new Arc2D.Double(xs - ws / 2, ys - hs / 2, ws, hs, angle1, angle2 - angle1,
                                 Arc2D.OPEN));
        draw();
    }
     ...
     * @throws IllegalArgumentException if either {@code halfWidth} or {@code halfHeight} is
     *                                  negative
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
     ...
     * @throws IllegalArgumentException if {@code filename} is {@code null}
     */
    public void picture(double x, double y, String filename, double scaledWidth,
                        double scaledHeight) {
        validate(x, "x");
        validate(y, "y");
    ...
    public void save(String filename) {
        ...
        try {
            ...
            BufferedImage saveImage = new BufferedImage(2 * width, 2 * height,
